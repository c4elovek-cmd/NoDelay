...
/**
 * NoDelay entry point (Forge, client side only).
 *
 ...
 */
@Mod(NoDelayForge.MODID)
public final class NoDelayForge {
	public static final String MODID = "nodelay";
	public static final Logger LOGGER = LoggerFactory.getLogger("nodelay-forge");
